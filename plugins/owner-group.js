...
async (robin, mek, m, { quoted, reply, isOwner }) => {
    try {
        ...
        return reply('2️⃣');
        return reply('1️⃣');
        return reply(`✔️ *Successfully Blocked: @${target.split('@')[0]}*`);
    } catch (e) {
...
async (robin, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, quoted }) => {
    try {
        ...
        // Confirm the action
        return reply(`✔️*Successfully removed: @${target.split('@')[0]}*`);
    } catch (e) {
...
async (robin, mek, m, { from, isGroup, isOwner, reply }) => {
    try {
        ...
        // Confirm leaving
        console.log(`✔️ *Successfully left the group: ${from}*`);
    } catch (e) {
...
async (robin, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, args }) => {
    try {
        ...
        // Confirm success
        return reply(`✔️ *Successfully added: @${target.split('@')[0]}*`);
    } catch (e) {
...
async (robin, mek, m, { from, isGroup, isAdmins, isBotAdmins, reply, quoted }) => {
    try {
        ...
        // Confirm the action
        return reply(`✔️ *Successfully removed admin privileges from: @${target.split('@')[0]}*`);
    } catch (e) {
